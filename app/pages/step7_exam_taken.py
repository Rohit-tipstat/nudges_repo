...
test_selected = st.selectbox("Select the country you want to study in:", test_options)
...
if submit:
    data_analysis_exam_score = analyze_student_exam_data(
        data=filtered_data,
        exam_taken=test_selected,
        score=score_obtained,
        course_type=course_stream_selected,
        source_city=current_city,
        country_selected=country_of_study,
        university_selected=university_name
    )
