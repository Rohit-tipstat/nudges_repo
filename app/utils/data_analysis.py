...
def course_type_analysis(data: pd.DataFrame, course_type: str, source_city: str, 
    ...
    filtered_data = data[data['Course Stream'] == course_type]
...
def analyze_student_exam_data(
    ...
    Args:
        ...
        country_selected (str): The country selected for study.
        university_selected (str): The university selected by the student.
...
#        (data['University Name'] == university_selected)
    ...
    top_applied_universities_ = (
        data[
            (data['Country of Study'] == country_selected) &
            (data[exam_taken] >= score - 10) &
